...
void IRAM_ATTR old_epd_draw_frame_1bit(Rect_t area, uint8_t *ptr, DrawMode_t mode, int32_t time);
 ...
 */
void old_epd_draw_pixel(int32_t x, int32_t y, uint8_t color,
                    uint8_t *framebuffer);
 ...
 */
void old_epd_draw_hline(int32_t x, int32_t y, int32_t length, uint8_t color,
                    uint8_t *framebuffer);
 ...
 * @param framebuffer The framebuffer to draw to
 */
void old_epd_draw_circle(int32_t x, int32_t y, int32_t r, uint8_t color, uint8_t *framebuffer);
 ...
 * @param framebuffer The framebuffer to draw to,
 */
void old_epd_fill_circle(int32_t x, int32_t y, int32_t r, uint8_t color, uint8_t *framebuffer);
