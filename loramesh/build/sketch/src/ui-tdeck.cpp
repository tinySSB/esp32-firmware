#line 1 "/home/nanomonkey/git/tinySSB/esp32/loramesh/src/ui-tdeck.cpp"
// ui-tdeck.cpp
...
void UI_TDeck_Class::to_next_screen() {}

void UI_TDeck_Class::buzz() {}

void UI_TDeck_Class::loop()
{
  lv_task_handler();
}
...
{
  ((UI_TDeck_Class*)theUI)->_brightness_cb(e);
}
...
void UI_TDeck_Class::_brightness_cb(lv_event_t *e)
{
  static char lvl;
...
void UI_TDeck_Class::_four_button_cb(lv_event_t *e)
{
...
UI_TDeck_Class::UI_TDeck_Class()
{

  // Serial.println("init of UI_TDeck_Class()");
